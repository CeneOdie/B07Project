package com.example.groceryapp.ui.customerHistory;
...
public class customerHistoryFragment extends Fragment {
    ...
    private CustomerHistoryViewModel mViewModel;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this).get(CustomerHistoryViewModel.class);
